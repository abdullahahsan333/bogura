            ...
            <div x-data="{ isOpen: false }" class="relative w-1/2 flex justify-end">
                ...
                <div x-show="isOpen" class="absolute w-52 bg-white rounded-lg shadow-lg py-2 mt-16">
                    ...
                    <a class="flex justify-start items-center gap-3 px-4 py-2 account-link hover:text-white" href="{{ route((!empty($url) ? $url : '') . '.logout') }}"
                        ...
                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em"><path fill="none" stroke-width="2" d="M13,9 L13,2 L1,2 L1,22 L13,22 L13,15 M22,12 L5,12 M17,7 L22,12 L17,17"></path></svg>
                        {{ __('Logout') }}
                    </a>
